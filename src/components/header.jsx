...
export default function Header() {
  ...
  return (
    <header className="w-full h-[72px] sticky top-0 z-50
      ...
      <div className="max-w-7xl mx-auto h-full px-4 md:px-6
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            to="/cart"
            className="hidden md:flex w-11 h-11 items-center justify-center
            rounded-full border border-gray-200 text-primary text-xl
